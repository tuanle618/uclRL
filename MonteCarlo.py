...
class Agent:    
    def __init__(self, env, discount_factor=1.0, epsilon=1e-6):
        """
        Initialized an Agent to solve a MDP via model free Monte-Carlo method.
        Params:
            env [OpenAI env.]
    ...
    def first_visit_MC(self, num_iter=10000, discount_factor=None):
        """
    ...
    def every_visit_MC(self, num_iter=10000, discount_factor=None):
        pass
...
def main():
    ...
    first_visit_MC_value_fnc = agent.first_visit_MC()
